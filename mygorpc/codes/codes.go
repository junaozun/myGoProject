...
// framework codes
var (
	ServerInternalError = NewFrameworkError(ServerInternalErrorCode,"server internal codes")
	ConfigError = NewFrameworkError(ConfigErrorCode,"config codes")
